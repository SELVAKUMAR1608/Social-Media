...
const Post = ({ post }) => {
    ...
    const isLiked = post.likes?.includes(authUser?._id ?? null);
    
    console.log("authuser_id:",authUser?._id);
    console.log("postUser_id:",post?.user._id);
            ...
            <div className='flex gap-2 items-start p-4 border-b border-gray-700'>
                <div className='avatar'>
                    <Link to={`/profile/${postOwner.username}`} className='w-8 rounded-full overflow-hidden'>
                        <img src={postOwner.profileImg || "/profile-default-image.jpg"} />
                    </Link>
                </div>
                                            ...
                                            <div key={comment._id} className='flex gap-2 items-start'>
                                                <div className='avatar'>
                                                    <div className='w-8 rounded-full'>
                                                        <img
                                                            src={comment.user.profileImg || "/profile-default-image.jpg"}
                                                        />
                                                    </div>
                                                </div>
